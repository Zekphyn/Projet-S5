...
public class Model implements Observable{
	...
	public Model(){
		...
		this.mot = new Word();
		this.image = new ImageIcon("src/images/pendu.jpg");
	...
	public void notifyObserver(){
		 this.image = new ImageIcon("src/images/pendu"+this.mot.getNombreErreur()+".jpg");
		 
		for(Observer obs : this.listObserver)
			obs.update(this.mot.getSecretWord(), this.score.getPoint(), "src/images/pendu"+this.mot.getNombreErreur()+".jpg", this.nombreMot);
	}
